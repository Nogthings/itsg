<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Administre donde tiene abiertas las sesiones.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Cerrar sesion de otros Navegadores') }}
            </x-jet-button>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor ingrese su contraseña para confirmar que desea cerrar sesión en los otros navegadores.') }}
