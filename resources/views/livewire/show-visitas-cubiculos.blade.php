            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <button type="button" wire:click='export' {{count($cubiculos) == 0 ? 'disabled' : ''}}
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Cubiculo</th>
                                    <th scope="col" class="px-4 py-3">Desde</th>
                                    <th scope="col" class="px-4 py-3">Hasta</th>
                                ...
                                @foreach ($cubiculos as $cubiculo)
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row"
                                            ...
                                            {{ $cubiculo->id }}</th>
                                        <td class="px-4 py-3">{{ $cubiculo->nombre_alumno }}</td>
                                        <td class="px-4 py-3">{{ $cubiculo->control_alumno }}</td>
                                        <td class="px-4 py-3">{{ $cubiculo->carrera->nombre_carrera }}</td>
                                        <td class="px-4 py-3">{{ $cubiculo->genero }}</td>
                                        <td class="px-4 py-3">{{ $cubiculo->cubiculo }}</td>
                                        <td class="px-4 py-3">{{ $cubiculo->hora_inicio }}</td>
                                        <td class="px-4 py-3">{{ $cubiculo->hora_fin }}</td>
                                        <td class="px-4 py-3">{{ $cubiculo->fecha }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
